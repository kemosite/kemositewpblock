...
/**
 * Title: Swatch Test
 * Slug: kemositewpblock/swatch-test
 * Categories: featured
 */
?>
...
.colour-swatch-test .colour-swatch-test-gang {
	display: flex;
	flex-direction: row;
...
.colour-swatch-test-gang .swatch {
	width: 3rem;
	height: 3rem;
...
<div class="colour-swatch-test">

<!-- Theme Colour Setting Test -->
<div class="colour-swatch-test-gang">
...
<div class="swatch" style="background-color: var(--kemosite_wordpress_base_primary_colour);">&nbsp;</div>
<div class="swatch" style="background-color: var(--kemosite_wordpress_secondary_colour);">&nbsp;</div>
