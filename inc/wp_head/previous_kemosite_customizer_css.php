...
function kemosite_customizer_css() {
	...
	*/
	...
	$kemosite_wordpress_selection_colour_source_lum = kemosite_hex_to_lum($kemosite_wordpress_selection_colour_source) * 100; // Expressed as %

	/*
	echo "<pre>";
	print_r("kemosite_wordpress_selection_colour_source: The source of our colour calculations.");
	echo "<br>";
	print_r($kemosite_wordpress_selection_colour_source);
	echo "<br>";
	echo "</pre>";
	*/
	...
	/*
	echo "<pre>";
	print_r("kemosite_wordpress_selection_colour_source_hsl_array:");
	echo "<br>";
	print_r($kemosite_wordpress_selection_colour_source_hsl_array);
	echo "<br>";
	print_r("kemosite_wordpress_selection_colour_source_lum:");
	echo "<br>";
	print_r($kemosite_wordpress_selection_colour_source_lum);
	echo "<br>";
	print_r("kemosite_wordpress_main_content_bg_color_light_mode_lum:");
	echo "<br>";
	print_r($kemosite_wordpress_main_content_bg_color_light_mode_lum);
	echo "<br>";
	print_r("kemosite_wordpress_main_content_bg_color_dark_mode_lum:");
	echo "<br>";
	print_r($kemosite_wordpress_main_content_bg_color_dark_mode_lum);
	echo "<br>";
	print_r("kemosite_wordpress_selection_colour_source_bg_contrast_light_mode:");
	echo "<br>";
	print_r($kemosite_wordpress_selection_colour_source_bg_contrast_light_mode);
	echo "<br>";
	print_r("kemosite_wordpress_selection_colour_source_bg_contrast_dark_mode:");
	echo "<br>";
	print_r($kemosite_wordpress_selection_colour_source_bg_contrast_dark_mode);
	echo "<br>";
	echo "</pre>";
	*/
	...
	if ( $kemosite_wordpress_selection_colour_source_bg_contrast_light_mode < 3):
		...
		$kemosite_wordpress_selection_colour_hsl_light_mode = kemosite_adjust_hsl_l_contrast(
			...
			$kemosite_wordpress_main_content_bg_color_light_mode_lum
		);

		/*
		echo "<pre>";
		print_r("kemosite_wordpress_selection_colour_hsl_light_mode:");
		echo "<br>";
		print_r($kemosite_wordpress_selection_colour_hsl_light_mode);
		echo "<br>";
		echo "</pre>";
		*/
	...
	endif; if ( $kemosite_wordpress_selection_colour_source_bg_contrast_dark_mode < 3):
		...
		$kemosite_wordpress_selection_colour_hsl_dark_mode = kemosite_adjust_hsl_l_contrast(
			...
			3,
			$kemosite_wordpress_selection_colour_source_lum,
			$kemosite_wordpress_main_content_bg_color_dark_mode_lum
		);

		/*
		echo "<pre>";
		print_r("kemosite_wordpress_selection_colour_hsl_dark_mode:");
		echo "<br>";
		print_r($kemosite_wordpress_selection_colour_hsl_dark_mode);
		echo "<br>";
		echo "</pre>";
